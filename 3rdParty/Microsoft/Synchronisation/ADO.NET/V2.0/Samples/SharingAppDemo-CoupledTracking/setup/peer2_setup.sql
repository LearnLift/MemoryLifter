...
--
CREATE TABLE peer2..orders_tombstone(
...
CREATE TABLE peer2..order_details_tombstone(
    order_id int NOT NULL primary key,             
    sync_row_timestamp timestamp, 
    sync_update_peer_key int default 0,
    sync_update_peer_timestamp bigint,        
...
--   
ALTER TABLE peer2..orders add sync_row_timestamp timestamp
ALTER TABLE peer2..order_details add sync_row_timestamp timestamp
go

ALTER TABLE peer2..orders add sync_update_peer_key int default 0
ALTER TABLE peer2..order_details add sync_update_peer_key int default 0
go

ALTER TABLE peer2..orders add sync_update_peer_timestamp bigint 
ALTER TABLE peer2..order_details add sync_update_peer_timestamp bigint 
go

ALTER TABLE peer2..orders add sync_create_peer_key int default 0
ALTER TABLE peer2..order_details add sync_create_peer_key int default 0
go

ALTER TABLE peer2..orders add sync_create_peer_timestamp bigint 
ALTER TABLE peer2..order_details add sync_create_peer_timestamp bigint 
go
