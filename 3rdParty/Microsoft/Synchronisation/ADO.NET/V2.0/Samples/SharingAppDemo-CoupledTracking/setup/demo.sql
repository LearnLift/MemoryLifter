...
delete peer1..scope_info
delete peer1..orders
delete peer1..orders_tombstone
delete peer1..order_details
delete peer1..order_details_tombstone

delete peer2..scope_info
delete peer2..orders
delete peer2..orders_tombstone
delete peer2..order_details
delete peer2..order_details_tombstone


delete peer3..scope_info
delete peer3..orders
delete peer3..orders_tombstone
delete peer3..order_details
delete peer3..order_details_tombstone
...
select * from peer1..orders_tombstone
select * from peer2..orders_tombstone
select * from peer3..orders_tombstone

select * from peer1..order_details
select * from peer2..order_details
select * from peer3..order_details

select * from peer1..order_details_tombstone
select * from peer2..order_details_tombstone
select * from peer3..order_details_tombstone
