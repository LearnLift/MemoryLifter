...
// Source:  http://www.codeproject.com/KB/list/lvsortmanager.aspx
//
///////////////
...
namespace MLifter.Components
{
    ...
    public class ListViewSizeSort : ListViewTextSort
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListViewSizeSort"/> class.
        /// </summary>
        /// <param name="sortColumn">Column to be sorted</param>
        /// <param name="ascending">true, if ascending order, false otherwise</param>
        /// <remarks>Documented by Dev05, 2009-03-26</remarks>
        public ListViewSizeSort(Int32 sortColumn, Boolean ascending)
            :
            base(sortColumn, ascending) { }
        ...
        protected override Int32 OnCompare(string lhs, string rhs)
        {
            return (Int32)(GetByteCount(lhs) - GetByteCount(rhs));
        }

        protected long GetByteCount(string size)
        {
