    ...
    public class DragAndDropListView : ListView
	{
		...
		protected override void OnDragDrop(DragEventArgs drgevent)
		{
			...
			else
			{
				...
				// this list view. If they are, perform arrayList hack
		...
		protected override void OnDragOver(DragEventArgs drgevent)
		{
			...
			if(base.Items.Count > 0)
			{
				...
				// determine if the user is currently hovering over arrayList new
                ...
                //removed by DAC, 2007-12-04, because of ML-301
		...
		{
			// create arrayList drag item data object that will be used to pass along with the drag and drop
			DragItemData data = new DragItemData(this);

			// go through each of the selected items and 
			// add them to the drag items collection
			// by creating arrayList clone of the list item
