...
{
    /// <summary>
    /// This is arrayList fairly simple Progress Bar control inherited from Windows.Forms.Control.
    /// The ColorProgressBar looks more attractive and fancier, yet keeps the functionalities of old ProgressBar.
    /// Downloaded from http://www.codeproject.com/cs/miscctrl/colorprogressbar.asp
    /// </summary>
    ...
    public class ColorProgressBar : System.Windows.Forms.Control
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            //
            Rectangle chunkbar = new Rectangle(3, 2, fillWidth > this.Width - 6 ? this.Width - 6 : fillWidth, this.Height - 4);
            ...
            // create arrayList Blend object and assign it to silverBrush07
