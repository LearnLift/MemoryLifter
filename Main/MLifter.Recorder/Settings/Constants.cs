...
namespace MLifter.AudioTools
{
    ...
    {
        public static readonly string SETTINGS_FILENAME = Application.StartupPath + @"\settings.xml";
        public static readonly string MEDIA_FOLDER = Application.StartupPath + @"\Media\";
