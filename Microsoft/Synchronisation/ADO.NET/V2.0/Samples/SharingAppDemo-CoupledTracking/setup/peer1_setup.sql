...
ALTER DATABASE peer1 SET ALLOW_SNAPSHOT_ISOLATION ON

CREATE TABLE peer1..orders(order_id int NOT NULL primary key, order_date datetime NULL)
go

CREATE TABLE peer1..order_details(order_id int NOT NULL primary key, order_details_id int NOT NULL, product nvarchar(100) NULL, quantity int NULL)
go
...
--
CREATE TABLE peer1..orders_tombstone(
...
CREATE TABLE peer1..order_details_tombstone(
    order_id int NOT NULL primary key,             
    sync_row_timestamp timestamp, 
    sync_update_peer_key int default 0,
    sync_update_peer_timestamp bigint,        
...
--   
ALTER TABLE peer1..orders add sync_row_timestamp timestamp
ALTER TABLE peer1..order_details add sync_row_timestamp timestamp
go

ALTER TABLE peer1..orders add sync_update_peer_key int default 0
ALTER TABLE peer1..order_details add sync_update_peer_key int default 0
go

ALTER TABLE peer1..orders add sync_update_peer_timestamp bigint 
ALTER TABLE peer1..order_details add sync_update_peer_timestamp bigint 
go

ALTER TABLE peer1..orders add sync_create_peer_key int default 0
ALTER TABLE peer1..order_details add sync_create_peer_key int default 0
go

ALTER TABLE peer1..orders add sync_create_peer_timestamp bigint 
ALTER TABLE peer1..order_details add sync_create_peer_timestamp bigint 
go
